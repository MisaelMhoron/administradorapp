	...
	<section class="content">
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="panel-heading">
					<h3 class="panel-title">Nueva asignacion categoria de mapa</h3>
				</div>
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('asignacategory.store') }}"  role="form" enctype= "multipart/form-data">
							{{ csrf_field() }}
<!-------------------------------------------------------------->	
<script>
...
font-size: 11pt" for="nombre">Categoria</label>
	<input type="text" name="idCategorias"  id="idCategorias" readonly  style=" font-family: Arial; font-size: 11pt;height:34px" class="form-control"  aria-describedby="basic-addon1" placeholder="N° de categoria..." value="{{ old('idCategorias') }}"></textarea>
	</div>
	</div>
	</div>
...
function llamarcategoria() {
	...
	var urlcategoria = 'https://www.turismoapps.com/modalcategoria';
    $.ajax({
        cache: false,
        async: true,
        type: "GET",
...
<div>						
		<div class="form-group">
		<label style="color: black;padding: 8px;font-family: Arial;
font-size: 11pt" for="nombre">N° de Eventos</label>
	<input type="text" name="idEventos"  id="idEventos" readonly  style=" font-family: Arial; font-size: 11pt;height:34px" class="form-control"  aria-describedby="basic-addon1" placeholder="N° de eventos..." value="{{ old('idEventos') }}"></textarea>
	</div>
	</div>
	</div>
...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 style="text-align:center" class="modal-title">EVENTOS</h4>
        </div>
        <div class="modal-body">
